 ...
 * @author xiaoHai
 */
public class ServiceSearchImpl extends CommonUtil {
    ...
    public static void beanService() {
        ...
        String serviceName = tableToBeanName + "SearchServiceImpl";
        String serviceInterface = tableToBeanName + "SearchService";
